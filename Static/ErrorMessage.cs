namespace MasterDegree.Static
{
    public static class ErrorMessage
    {
        public const string ERROR_USER_NOT_FOUND = "Nie znaleziono użytkownika o podanym id.";
        public const string ERROR_PRODUCT_NOT_FOUND = "Nie znaleziono produktu o podanym id.";
        public const string ERROR_USER_FAVORITE_NOT_FOUND = "Nie znaleziono polubionego produktu o podanym id.";
